...
# -------- main function --------
EM_MIRT <- function(y,            # dataset, all responses of all subjects
                    mu_t,         # true mu (mean vector of latent traits)
                    sigma_t,      # true sigma (coviarance of latent traits)
                    ...
                    grid_num      # number of grid points each dimension
){
